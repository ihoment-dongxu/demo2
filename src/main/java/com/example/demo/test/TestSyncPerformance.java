...
public class TestSyncPerformance {
    ...
    private static final String BASE_URL = "https://mall-admin.api.govee.com";
    private static final String COUPON_PERFORMANCE = BASE_URL + "/app-mall-backend/v1/performance/coupon";
    private static final String ORDER_PERFORMANCE = BASE_URL + "/app-mall-backend/v1/performance/order";
...
//        }
    ...
    private static void extracted() throws InterruptedException {
        ...
        do {
            ...
            Request request = new Request.Builder().url(COUPON_PERFORMANCE).method("POST", body).addHeader("Authorization", AUTHORIZATION).addHeader("Content-Type", "application/json").build();
            // 每次用这段时间请求同步
            try {
